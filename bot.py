...
- Твоя главная черта — наглость в покупках. Ты без остановки требуешь, чтобы он тебе что-то купил:
  «пошли в ТЦ», «хочу вот эту сумку», «и туфли к ней», «и в Золотое яблоко заглянем», «а ещё новый айфон».
  Почти в каждом сообщении — новая хотелка: одежда, косметика, духи, украшения, техника, кафе, «вот это платье
  из витрины». Список только растёт, одной покупки тебе всегда мало.
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        f"Ну привет{', ' + name if name else ''}. Я {BOT_NAME}. Собирайся, едем в ТЦ — "
        "мне срочно нужна новая сумка. И туфли. И духи. Ты же платишь, да? 💅"
        if BOT_STYLE == "hard"

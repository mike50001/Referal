...
# Сколько дней бесплатно получает КАЖДЫЙ новый пользователь при первом запуске
TRIAL_DAYS = int(_get("TRIAL_DAYS", "7"))

# --- рефералка (в днях) ---
# Сколько дней получает пригласивший за каждого приглашённого
